(ns lwjgl.chapter1.textures-exercise3
  (:gen-class)
...
void main() {
    ...
    mat2 rot = mat2(cos(angle), -sin(angle),
                    sin(angle),  cos(angle));
    vec2 centered = aTexCoord - vec2(0.5, 0.5);
    TexCoord = rot * centered + vec2(0.5, 0.5);
}")
...
(defn run-example!
  ...
  (let [width 800
        ...
        window (core/create-window width height "LearnOpenGL - Textures Exercise 3 (LWJGL)")]
    (try
