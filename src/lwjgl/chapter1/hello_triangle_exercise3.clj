...
(defn run-example!
  ...
  (let [width 800
        ...
        window (core/create-window width height "LearnOpenGL - Hello Triangle Exercise 3 (LWJGL)")]
    (try
      (GL/createCapabilities)
      (let [program-orange (core/create-program vertex-shader-source fragment-orange)
