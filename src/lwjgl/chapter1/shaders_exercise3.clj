(ns lwjgl.chapter1.shaders-exercise3
  (:gen-class)
...
(defn- create-colored-triangle
  ...
  (let [vertices (float-array
    ...
    (GL20/glVertexAttribPointer 2 3 GL11/GL_FLOAT false stride (* 3 Float/BYTES))
...
(defn run-example!
  ...
  (let [width 800
        ...
        window (core/create-window width height "LearnOpenGL - Shaders Exercise 3 (LWJGL)")]
    (try
