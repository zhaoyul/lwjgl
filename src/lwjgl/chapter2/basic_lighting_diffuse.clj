(ns lwjgl.chapter2.basic-lighting-diffuse
  (:gen-class)
...
(defn run-example!
  ...
  (let [width 800
        ...
        window (core/create-window width height "LearnOpenGL - Basic Lighting (Diffuse) (LWJGL)")]
    (try
      ...
      (let [lighting-program (core/create-program vertex-shader-source fragment-shader-source)
        ...
        (try
          ...
          (when (<= 0 light-color-loc)
            (GL20/glUniform3f light-color-loc 1.0 1.0 1.0))
